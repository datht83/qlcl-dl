...
<div class="container">
    ...
    <div class="tab-content">
        <div id="home" class="tab-pane fade in active"><?php include "form_gt.php"; ?></div>
        <div id="menu0" class="tab-pane fade"><?php include "form_tn.php"; ?></div>
        <div id="menu1" class="tab-pane fade"><?php include "form_bb.php"; ?></div>
        <div id="menu2" class="tab-pane fade"><?php include "form_bc.php"; ?></div>
    </div>
</div>
